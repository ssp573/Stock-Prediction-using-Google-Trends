...
val df1 = df_ret.select(df_ret("Adjusted_Close").as("label"),$"_2",$"_3",$"_4",$"_5",$"_6",$"_7",$"_8",$"_9",$"_10",$"_11",$"_12",$"_13",$"_14",$"_15",$"_16",$"_17",$"Open_2",$"Change_Percent")
/*df1.columns
for (w<-df1.columns){
println(w+s" "+df1.stat.corr("label",w))
}*/
df1.show(10)
val assemb = new VectorAssembler().setInputCols(Array("_2","_3","_4","_5","_6","_7","_8","_9","_10","_11","_12","_13","_14","_15","_16","_17","Open_2","Change_Percent")).setOutputCol("features") 
